...
export default function PageQuiz() {
  ...
  const { answers, id, question, correctAnswer } = questions[activeQuestion];
    ...
    <div className="flex flex-col justify-center items-center">
      ...
      <div className="max-w-sm rounded overflow-hidden shadow-lg bg-gray-100">
        {!showResult ? (
          ...
          <div className="font-bold text-xl mb-2 text-black flex flex-col">{question}</div>
          <div className="text-gray-700 text-base flex flex-col gap-1">
            {answers.map((answer, idx)=>(
              <button key={idx} 
              className={`
               g-transparent hover:bg-blue-500
          ...
          <div className="px-6 py-4 text-black">
            <h1 className="font-bold text-xl texte-blue-600">Resultados</h1>
        ...
        <div className="px-6 pt-4 pb-2 flex justify-center">
          ...
          disabled={!checked} 
            className={`
             bg-gray-400 
             text-white font-bold py-2 px-4 rounded-full select-none
              ${
